...
- `github-pr-prep`: Prepare high-signal PR packages from local changes, including summary, risk analysis, and test evidence. (file: `/Users/garethbaumgart/Source/money-tracker/skills/github-pr-prep/SKILL.md`)
...
### How to use skills
- Trigger by naming a skill directly (for example, `$github-pr-prep`) or by asking for work that clearly matches the skill description.
